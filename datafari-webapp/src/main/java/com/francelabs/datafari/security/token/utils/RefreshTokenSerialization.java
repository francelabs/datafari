...
public class RefreshTokenSerialization {

  private static final Logger LOGGER = LogManager.getLogger(RefreshTokenSerialization.class.getName());

  public static String serialize(final OAuth2RefreshToken accessToken) {
    try {
  ...
  public static OAuth2RefreshToken deserialize(final String accessTokenStr) {
    try {
