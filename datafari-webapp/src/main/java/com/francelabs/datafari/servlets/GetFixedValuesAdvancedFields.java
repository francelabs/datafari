 ...
 *
 * returns a JSON object containing the list of fields that have predefined values and their
 * predefined values list. This JSON is found in the advanced-search.properties file
 */
