 ...
 *
 * returns the list of fields that have an associated suggester component in Solr. The suggester is
 * used to enable an autocomplete widget for those fields. This list is found in the
