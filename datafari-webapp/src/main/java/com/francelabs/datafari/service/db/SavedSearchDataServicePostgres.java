...
public class SavedSearchDataServicePostgres {
  ...
  private static SavedSearchDataServicePostgres instance;

  private final PostgresService pgService = new PostgresService();

  public static synchronized SavedSearchDataServicePostgres getInstance() {
    if (instance == null) {
      instance = new SavedSearchDataServicePostgres();
    }
    return instance;
  }
