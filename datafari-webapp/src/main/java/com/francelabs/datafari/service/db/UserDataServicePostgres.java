...
public class UserDataServicePostgres {

    final static Logger logger = LogManager.getLogger(UserDataServicePostgres.class.getName());
    private static UserDataServicePostgres instance;
    ...
    public static synchronized UserDataServicePostgres getInstance() {
        if (instance == null) {
            instance = new UserDataServicePostgres();
        }
        return instance;
    }

    private UserDataServicePostgres() {
