...
public class AccessTokenDataServicePostgres {

  private static final Logger logger = LogManager.getLogger(AccessTokenDataServicePostgres.class.getName());
  ...
  private static AccessTokenDataServicePostgres instance;
  private final PostgresService pgService = new PostgresService();
  private final String userDataTTL;

  private AccessTokenDataServicePostgres() {
  ...
  public static synchronized AccessTokenDataServicePostgres getInstance() throws DatafariServerException {
    if (instance == null) {
      instance = new AccessTokenDataServicePostgres();
    }
    return instance;
  }
