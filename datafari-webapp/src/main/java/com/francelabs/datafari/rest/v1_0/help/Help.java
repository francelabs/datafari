 ...
 *******************************************************************************/
package com.francelabs.datafari.rest.v1_0.help;
...
public class Help {
    ...
    private static final String BASE_FILE_NAME = "helpContent";
    private static final String FILE_EXTENSION = ".jsp";
    private final static Logger LOGGER = LogManager.getLogger(Help.class.getName());

    @GetMapping(value = "/rest/v1.0/help/{lang}", produces = "application/json;charset=UTF-8")
    protected String getCurrentUserAlerts(final HttpServletRequest request, @PathVariable("lang") String lang) {
        ...
        String basePath = environnement + File.separator + "tomcat" + File.separator + "webapps" + File.separator
                + "Datafari" + File.separator + "resources" + File.separator + "helpAssets";
        ...
        try {
            ...
            jsonResponse.put("htmlHelpContent", fileContent);
            ...
            try {
                ...
                LOGGER.warn("Unexpected error while retrieving help content with rest API", e1);
                throw new InternalErrorException("Unexpected error while retrieving help content");
            }
        } catch (IOException e) {
            LOGGER.warn("Unexpected error while retrieving help content with rest API", e);
            throw new InternalErrorException("Unexpected error while retrieving help content");
        }
    }
