...
public class Licence {
    ...
    @GetMapping(value = "/rest/v1.0/licence", produces = "application/json;charset=UTF-8")
    protected String doGet(final HttpServletRequest request) {

        final JSONObject jsonResponse = new JSONObject();
        jsonResponse.put("type", "DatafariCE");
        jsonResponse.put("contact", "");
        jsonResponse.put("time", "valid");
        jsonResponse.put("files", "valid");
