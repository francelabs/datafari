...
public class TestAgentBuilder implements IAgentBuilder {
   ...
   */
    public TestAgentBuilder(HttpServletRequest request, AiRequest params, ChatStream stream, SourcesAccumulator sourcesAcc) {
        ...
        try {
            ...
            // Tools
            Object datafariTools = new TestTools(request, params, stream, sourcesAcc);
            ...
            this.agent = AgenticServices.agentBuilder(TestAgentService.class)
                .chatModel(chatModel)
            ...
            this.streamingAgent = AgenticServices.agentBuilder(TestStreamingAgentService.class)
