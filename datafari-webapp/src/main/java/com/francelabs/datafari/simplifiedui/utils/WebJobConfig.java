...
public class WebJobConfig {
  ...
  public String createJob(final WebJob webJob) throws Exception {
    ...
    if (enableVectorSearchSpec != null) {
      enableVectorSearchSpec.replace(attributeValue, webJob.isEnableVectorSearch());
    }

    // Set enableEmbeddingsAtIndexing
    if (enableEmbeddingsAtIndexingSpec != null) {
      enableEmbeddingsAtIndexingSpec.replace(attributeValue, webJob.isEnableEmbeddingsAtIndexing());
    }
