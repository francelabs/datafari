...
AjaxFranceLabs.QueryHighlightingWidget = AjaxFranceLabs.FacetCore.extend({
  ...
  adjustScroll : function(hlElement, docContentDiv) {
    ...
    // Min scrollBottom to be sure that the hlElement is visible
    var minScrollBottom = scrollTop + hlPos - contentDivOffset + lineHeight;
    ...
    if (targetScrollTop < scrollTop || minScrollBottom > scrollBottom) {
