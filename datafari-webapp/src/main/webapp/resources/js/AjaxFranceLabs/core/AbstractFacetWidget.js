...
AjaxFranceLabs.AbstractFacetWidget = AjaxFranceLabs.AbstractWidget.extend({
  ...
  remove : function(value) {
    if (this.selectionType !== 'OR')
      return this.manager.store.removeByValue('fq', new RegExp('^-?' + this.field + ':' + AjaxFranceLabs.Parameter.escapeRegExp(AjaxFranceLabs.Parameter.escapeValue(value))));
    if (this.manager.store.find('fq', new RegExp(this.field + ':' + AjaxFranceLabs.Parameter.escapeRegExp(AjaxFranceLabs.Parameter.escapeValue(value))))) {
      var fq = this.manager.store.get('fq')[this.manager.store.find('fq', new RegExp(this.field + ':'))];
      fq.val(fq.val().replace(new RegExp(this.field + ':' + AjaxFranceLabs.Parameter.escapeRegExp(AjaxFranceLabs.Parameter.escapeValue(value)) + ' '), ''));
