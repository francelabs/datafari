    ...
    if (data.response.numFound === 0) {
      ...
      $.each(data.response.docs, function(i, doc) {
        if (doc.url != undefined) {
          ...
          elm.find('.doc_list').append('<div class="doc e-' + i + '" id="' + doc.id + '"></div>');
          ...
          if (self.isMobile) {
            ...
            elm.find('.doc:last .icon').append(
                '<object data="resources/images/icons/' + extension.toLowerCase() + '-icon-24x24.png"><img src="resources/images/icons/default-icon-24x24.png" /></object>&nbsp;');
