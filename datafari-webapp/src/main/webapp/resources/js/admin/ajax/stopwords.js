//# sourceURL=/Datafari/resources/js/admin/ajax/stopwords.js
        ...
        .ajax({ // Ajax request to get the content
          ...
          success : function(data, textStatus, jqXHR) {
            ...
            // Else print the content of the file in a textArea
              ...
              $("#fields")
                  .append(
                      "<div><div class='row'><label class='col-sm-3 col-form-label' id='stopWordsConfirm'>Click to save and activate the modifications</label><div class='col-sm-3 col-form-label'><button type=\"Submit\" class=\"col-sm btn btn-primary btn-label-left\" id=\"submit\" data-loading-text=\"<i class='fa fa-spinner fa-spin'></i> "
                          + window.i18n.msgStore['confirm'] + "\">" + window.i18n.msgStore['confirm'] + "</button></div></div></div>");
