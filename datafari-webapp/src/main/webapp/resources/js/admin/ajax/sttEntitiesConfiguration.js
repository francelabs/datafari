    ...
    .ready(
        function() {
          ...
          function setupLanguage() {
            ...
            $("#topbar3").text(window.i18n.msgStore['adminUI-sttEntitiesConfiguration']);
            $("#title").text(window.i18n.msgStore['adminUI-sttEntitiesConfiguration']);
            $("#documentation-entityextraction").text(window.i18n.msgStore['documentation-entityextraction']);
            $("#removedSttEntitiesConfiguration").text(window.i18n.msgStore['removedSttEntitiesConfiguration']);
          ...
          function initValues() {
            $.get("../SearchAdministrator/sttEntitiesConfiguration", function(data) {
