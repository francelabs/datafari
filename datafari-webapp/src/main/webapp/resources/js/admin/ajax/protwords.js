//# sourceURL=/Datafari/resources/js/admin/ajax/protwords.js
        ...
        .ajax({ // Ajax request to get the content
          ...
          success : function(data, textStatus, jqXHR) {
            ...
            // Else print the content of the file in a textArea
              ...
              $("#fields")
                  .append(
                      "<div><div class='row'><label class='col-sm-3 col-form-label'>Click to save and activate the modifications</label><div class='col-sm-3 col-form-label'><button type=\"Submit\" class=\"btn btn-primary btn-label-left\" id=\"submit\" data-loading-text=\"<i class='fa fa-spinner fa-spin'></i> "
