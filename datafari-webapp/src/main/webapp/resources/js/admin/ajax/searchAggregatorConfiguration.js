    ...
    $("#search_aggregator_activation").change(function click_handler(e) {
      ...
      $.post("../SearchAdministrator/searchAggregatorConfig", {
        ...
        if (data.code == undefined || data.code != 0) {
          ...
          if (enable == "true") {
            // Disable the query elevator graphical tool in case it is enabled. 
            // This is because the query elevator graphical tool is not compatible with the search aggregation
            $.post("../WidgetManager", {
              id: "queryelevator",
              activated: false
            }, "json");
