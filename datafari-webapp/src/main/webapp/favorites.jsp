...
<link rel="stylesheet" type="text/css" href="<c:url value="/resources/css/favorites.css" />" media="screen">
<script type="text/javascript" src="<c:url value="/resources/js/favorites.js" />"></script>
