//# sourceURL=/Datafari/admin/ajax/js/promoLink.js
...
function addProm(){
	...
	$("#div1").append("<div class=\"col-sm-2 control-label\"><span class=\"fa fa-asterisk \" style=\"color : red\"></span><label class=\"control-label\">"+window.i18n.msgStore['keyword']+"</label></div>");
	...
	$("#fieldDate").append("<div class=\"form-group\" id=\"div3\"><label class=\"col-sm-2 control-label\">"+window.i18n.msgStore['dateStart']+"</label><input type=\"text\" id=\"dateB\" name=\"dateB\" class=\"col-sm-2\" placeholder=\"Date\"></div>");
	...
	$("#div4").append("<input type=\"Submit\" id=\"newPromoLink\" name=\"addProm\" class=\"btn btn-primary btn-label-left col-sm-2\" value="+window.i18n.msgStore['confirm']+" /><div class=\"col-sm-6\"></div><i class=\"fa fa-asterisk\" style=\"color : red\"></i><label class=\"control-label\">"+window.i18n.msgStore['mandatoryField']+"</label>");
	$("#add").append("</div>");
	$("#addBox").append("</form>");
	        ...
	        success: function(data, textStatus, jqXHR) {
	        	if(data.toString().indexOf("Error code : ")!==-1){
	        		...
	        		$("#addPromFormBis").append("<div class=\"col-sm-2\"></div></br><div class=\"col-sm-2\"></div>");
	 				...
	 				$("#addPromFormBis").append("<div class=\"col-sm-2\"></div>");
	        		$("#addPromFormBis").append("<a href=\"javascript: add()\" style=\"color: inherit; text-decoration: inherit;\"><button class=\"btn btn-primary btn-label-left col-sm-1\" id=\"confirm\">"+window.i18n.msgStore['yes']+"</button></a>");
	        		$("#addPromFormBis").append("<div class=\"col-sm-2\"></div>");
	        		$("#addPromFormBis").append("<a href=\"javascript: cancel()\" style=\"color: inherit; text-decoration: inherit;\"><button class=\"btn btn-primary btn-label-left col-sm-1\" id=\"confirm\">"+window.i18n.msgStore['no']+"</button></a><br />	");
