//# sourceURL=/Datafari/admin/ajax/js/corpusOTAnalysis.js
...
$(document).ready(function() {
  $.get("../SearchExpert/ELKAdmin", function(data) {
    if ((data.ELKactivation == "true" && data.isELKUp == "true") || data.isELKUp == "true") {
      ...
      $('#iFrameContent').attr('src', kibanaURI + "#/dashboard/Content-Analysis-Over-Time");
      $('#warning').hide();
...
function setupLanguage() {
  ...
  document.getElementById("topbar3").innerHTML = window.i18n.msgStore['adminUI-CorpusOTStats'];
}