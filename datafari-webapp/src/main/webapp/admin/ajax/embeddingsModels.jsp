...
<head>
<script src="<c:url value="/resources/js/admin/ajax/embeddingsModelsConf.js" />" type="text/javascript"></script>
<link rel="stylesheet" type="text/css" href="<c:url value="/resources/css/admin/ragConfiguration.css" />" />
<meta charset="UTF-8">
<title>Embeddings Models Configuration</title>
    ...
    <div id="thBox" class="box-content">
      <div class="documentation-style-no-margin">
        <p class="documentation-preview">
          <span id="documentation-embeddingsModels">Datafari Enterprise v6.2 provides AI powered features</span><a
      ...
      <form class="form-horizontal needs-validation" id="embeddingsModels-form" novalidate onsubmit="return false">
            ...
            <table class="table table-striped" id="models-table">
              <thead>
                <tr>
                  ...
                  <th class="text-left" id="columnVectorField"></th>
        ...
        <div class="form-group row" id="model-form-container" style="display:none;">
          <div class="col-sm-12">
            <h4 id="form-title">Model form</h4>
              ...
              <div class="form-group row">
                <label for="vectorField" class="col-sm-2 col-form-label" id="vectorFieldLabel"></label>
                <div class="col-sm-5">
                  <input type="text" id="vectorField" class="form-control" placeholder="vector_1536_mymodel" required />
                </div>
              </div>
              <div class="form-group row">
