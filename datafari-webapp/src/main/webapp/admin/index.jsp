...
<%@ page import="java.util.Locale" %> <%-- supprime si non utilisé --%>
...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="<c:url value='/resources/css/style_v2.css'/>">
...
<!--Start Container-->
	...
	<!--Start Content-->
      <div id="content" class="calc-height"></div>
    </div>
