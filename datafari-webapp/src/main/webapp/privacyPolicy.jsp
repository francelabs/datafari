...
<html lang="en">
    <head>
        ...
        <link rel ="stylesheet" type ="text/css" href ="<c:url value="/resources/css/help-header.css" />" />
    ...
    <body class="gecko win">
        ...
        <div id="solr">
            <jsp:include page="/resources/privacyPolicyAssets/privacyPolicyContent.jsp" />
        </div>
