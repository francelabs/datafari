...
<html>
  <head>
    <title>The page you are looking is not here! (404)</title>
  ...
  <body>
    ...
    <img class="sammy" src="<c:url value="/resources/images/errors/Datafari_404_Backrground_Picture.jpg" />"></img>  
    <div class="waves"></div>
    <div class="oops-copy">
      <h1>Not found ! The requested resource could not be found.</h1>
