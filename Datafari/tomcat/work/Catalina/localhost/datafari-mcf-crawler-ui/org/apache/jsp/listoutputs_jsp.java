 ...
 * Generated at: 2014-02-25 15:01:33 UTC
...
public final class listoutputs_jsp extends org.apache.jasper.runtime.HttpJspBase
...
/* $Id: listoutputs.jsp 1555615 2014-01-05 19:19:40Z kwright $ */
...
*/
      ...
      out.write("\t<title>\r\n");
      out.write("\t\t");
      out.print(Messages.getBodyString(pageContext.getRequest().getLocale(),"listoutputs.ApacheManifoldCFListOutputConnections"));
      out.write("\r\n");
      out.write("\t</title>\r\n");
      out.write("\r\n");
      ...
      out.print(Messages.getBodyJavascriptString(pageContext.getRequest().getLocale(),"listoutputs.DeleteOutputConnection"));
      ...
      out.print(Messages.getBodyString(pageContext.getRequest().getLocale(),"listoutputs.ListOfOutputConnections"));
      out.write("</p>\r\n");
	...
	IOutputConnection[] connections = manager.getAllConnections();
      ...
      out.print(Messages.getBodyString(pageContext.getRequest().getLocale(),"listoutputs.Name"));
      out.write("</nobr></td>\r\n");
      out.write("\t\t\t\t<td class=\"columnheader\"><nobr>");
      out.print(Messages.getBodyString(pageContext.getRequest().getLocale(),"listoutputs.Description"));
      out.write("</nobr></td>\r\n");
      out.write("\t\t\t\t<td class=\"columnheader\"><nobr>");
      out.print(Messages.getBodyString(pageContext.getRequest().getLocale(),"listoutputs.ConnectionType"));
      out.write("</nobr></td>\r\n");
      out.write("\t\t\t\t<td class=\"columnheader\">");
      out.print(Messages.getBodyString(pageContext.getRequest().getLocale(),"listoutputs.Max"));
      out.write("</td>\r\n");
      out.write("\t\t\t</tr>\r\n");
	...
	while (i < connections.length)
	{
      ...
      out.write("\t\t\t\t<nobr>\r\n");
      out.write("\t\t\t\t\t<a href='");
      out.print("viewoutput.jsp?connname="+java.net.URLEncoder.encode(name,"UTF-8"));
      out.write("' alt='");
      out.print(Messages.getAttributeString(pageContext.getRequest().getLocale(),"listoutputs.View")+" "+org.apache.manifoldcf.ui.util.Encoder.attributeEscape(name));
      out.write('\'');
      out.write('>');
      out.print(Messages.getBodyString(pageContext.getRequest().getLocale(),"listoutputs.View"));
      out.write("</a>\r\n");
      out.write("\t\t\t\t\t<a href='");
      out.print("editoutput.jsp?connname="+java.net.URLEncoder.encode(name,"UTF-8"));
      out.write("' alt='");
      out.print(Messages.getAttributeString(pageContext.getRequest().getLocale(),"listoutputs.Edit")+" "+org.apache.manifoldcf.ui.util.Encoder.attributeEscape(name));
      out.write('\'');
      out.write('>');
      out.print(Messages.getBodyString(pageContext.getRequest().getLocale(),"listoutputs.Edit"));
      out.write("</a>\r\n");
      ...
      out.write("' alt='");
      out.print(Messages.getAttributeString(pageContext.getRequest().getLocale(),"listoutputs.Delete")+" "+org.apache.manifoldcf.ui.util.Encoder.attributeEscape(name));
      out.write('\'');
      out.write('>');
      out.print(Messages.getBodyString(pageContext.getRequest().getLocale(),"listoutputs.Delete"));
      out.write("</a>\r\n");
      out.write("\t\t\t\t</nobr>\r\n");
      out.write("\t\t\t</td>\r\n");
      out.write("\t\t\t<td class=\"columncell\">");
      ...
      out.write("\t\t\t\t<td class=\"separator\" colspan=\"5\"><hr/></td>\r\n");
      out.write("\t\t\t</tr>\r\n");
      out.write("\t\t\t<tr><td class=\"message\" colspan=\"5\"><a href=\"editoutput.jsp\" alt=\"");
      out.print(Messages.getAttributeString(pageContext.getRequest().getLocale(),"listoutputs.AddAnOutputConnection"));
      out.write('"');
      out.write('>');
      out.print(Messages.getBodyString(pageContext.getRequest().getLocale(),"listoutputs.AddaNewOutputConnection"));
      out.write("</a></td></tr>\r\n");
      out.write("\t\t</table>\r\n");
      out.write("\r\n");
