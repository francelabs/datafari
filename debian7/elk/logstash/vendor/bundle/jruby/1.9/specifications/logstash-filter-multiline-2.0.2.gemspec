# -*- encoding: utf-8 -*-
# stub: logstash-filter-multiline 2.0.2 ruby lib
...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<logstash-filter-mutate>, [">= 0"])
      s.add_runtime_dependency(%q<jls-grok>, ["~> 0.11.0"])
      ...
      s.add_dependency(%q<logstash-filter-mutate>, [">= 0"])
      s.add_dependency(%q<jls-grok>, ["~> 0.11.0"])
