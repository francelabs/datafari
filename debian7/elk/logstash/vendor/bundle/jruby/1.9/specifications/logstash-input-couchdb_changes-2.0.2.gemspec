# -*- encoding: utf-8 -*-
# stub: logstash-input-couchdb_changes 2.0.2 ruby lib
...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_development_dependency(%q<logstash-devutils>, [">= 0.0.6"])
      s.add_development_dependency(%q<logstash-output-elasticsearch>, [">= 0"])
    else
      ...
      s.add_dependency(%q<logstash-devutils>, [">= 0.0.6"])
