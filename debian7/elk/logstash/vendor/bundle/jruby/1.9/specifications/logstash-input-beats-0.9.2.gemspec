# -*- encoding: utf-8 -*-
# stub: logstash-input-beats 0.9.2 ruby lib
...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      s.add_runtime_dependency(%q<logstash-core>, ["< 3.0.0", ">= 1.5.4"])
      ...
      s.add_development_dependency(%q<logstash-codec-multiline>, [">= 0"])
    else
      s.add_dependency(%q<logstash-core>, ["< 3.0.0", ">= 1.5.4"])
      ...
      s.add_dependency(%q<logstash-codec-multiline>, [">= 0"])
    end
  else
    s.add_dependency(%q<logstash-core>, ["< 3.0.0", ">= 1.5.4"])
    s.add_dependency(%q<logstash-codec-plain>, [">= 0"])
