# -*- encoding: utf-8 -*-
# stub: logstash-output-graphite 2.0.2 ruby lib
...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_development_dependency(%q<logstash-filter-kv>, [">= 0"])
      s.add_development_dependency(%q<logstash-filter-ruby>, [">= 0"])
    else
      ...
      s.add_dependency(%q<logstash-filter-kv>, [">= 0"])
      s.add_dependency(%q<logstash-filter-ruby>, [">= 0"])
    end
  else
    s.add_dependency(%q<logstash-core>, ["< 3.0.0", ">= 2.0.0.beta2"])
    s.add_dependency(%q<logstash-devutils>, [">= 0"])
