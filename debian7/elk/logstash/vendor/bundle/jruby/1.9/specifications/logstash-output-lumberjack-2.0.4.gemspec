# -*- encoding: utf-8 -*-
# stub: logstash-output-lumberjack 2.0.4 ruby lib
...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<jls-lumberjack>, [">= 0.0.26"])
      s.add_runtime_dependency(%q<stud>, [">= 0"])
      s.add_development_dependency(%q<logstash-devutils>, [">= 0"])
      s.add_development_dependency(%q<logstash-output-lumberjack>, [">= 0"])
      ...
      s.add_dependency(%q<jls-lumberjack>, [">= 0.0.26"])
      s.add_dependency(%q<stud>, [">= 0"])
      s.add_dependency(%q<logstash-devutils>, [">= 0"])
      s.add_dependency(%q<logstash-output-lumberjack>, [">= 0"])
