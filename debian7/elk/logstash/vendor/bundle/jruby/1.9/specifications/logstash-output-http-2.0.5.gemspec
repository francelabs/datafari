# -*- encoding: utf-8 -*-
# stub: logstash-output-http 2.0.5 ruby lib
...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<logstash-mixin-http_client>, ["< 3.0.0", ">= 2.0.2"])
      s.add_runtime_dependency(%q<manticore>, ["< 0.5.0"])
      ...
      s.add_dependency(%q<logstash-mixin-http_client>, ["< 3.0.0", ">= 2.0.2"])
      s.add_dependency(%q<manticore>, ["< 0.5.0"])
