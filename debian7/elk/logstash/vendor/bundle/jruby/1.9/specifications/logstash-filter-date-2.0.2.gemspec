# -*- encoding: utf-8 -*-
# stub: logstash-filter-date 2.0.2 ruby lib
...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<logstash-input-generator>, [">= 0"])
      s.add_runtime_dependency(%q<logstash-codec-json>, [">= 0"])
      s.add_runtime_dependency(%q<logstash-output-null>, [">= 0"])
      ...
      s.add_dependency(%q<logstash-output-null>, [">= 0"])
