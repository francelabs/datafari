# -*- encoding: utf-8 -*-
# stub: logstash-patterns-core 2.0.2 ruby lib
...
Gem::Specification.new do |s|
  ...
  s.metadata = { "logstash_plugin" => "true" } if s.respond_to? :metadata=
  s.require_paths = ["lib"]
  s.authors = ["Elastic"]
  s.date = "2015-10-14"
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_development_dependency(%q<logstash-filter-grok>, [">= 0"])
    else
