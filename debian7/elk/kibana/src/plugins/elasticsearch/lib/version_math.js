...
var compare = function compare(required, installed) {
...
var sortVersions = function sortVersions(versions) {
...
/*
  ...
  is assumed
*/
var is = function is(equation, versions) {
  var _versions = sortVersions(versions);
  var _v = equation;
  var _cf;
