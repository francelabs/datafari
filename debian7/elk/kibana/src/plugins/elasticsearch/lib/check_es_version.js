...
module.exports = function (server) {
  ...
  return client.nodes.info().then(function (info) {
    ...
    var message = 'This version of Kibana requires Elasticsearch ' + (minimumElasticsearchVersion + ' or higher on all nodes. I found ') + ('the following incompatible nodes in your cluster: ' + badNodeNames.join(','));
