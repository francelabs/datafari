...
/***/ function(module, exports, __webpack_require__) {
	...
	var notify = __webpack_require__(308);

	__webpack_require__(972);
	__webpack_require__(981);

	__webpack_require__(1).setTabs([{
	  id: '',
	  title: 'Server Status',
	  activeIndicatorColor: '#EFF0F2'
	}]).setRootTemplate(__webpack_require__(982)).setRootController('ui', function ($http, $scope) {
	  var ui = this;
	  ui.loading = false;
	  ...
	  ui.refresh = function () {
	    ...
	    return $http.get('/api/status').then(function (resp) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var toTitleCase = __webpack_require__(977);
	var formatNumber = __webpack_require__(978);
	var readStatData = __webpack_require__(979);
	...
	__webpack_require__(214).get('kibana', ['nvd3']).directive('statusPageMetric', function () {
	  return {
	    restrict: 'E',
