 ...
 * Generated at: 2015-04-07 13:47:48 UTC
...
public final class listgroups_jsp extends org.apache.jasper.runtime.HttpJspBase
...
*/
      ...
      out.write("\t<title>\r\n");
      out.write("\t\t");
      out.print(Messages.getBodyString(pageContext.getRequest().getLocale(),"listgroups.ApacheManifoldCFListAuthorityGroups"));
      out.write("\r\n");
      out.write("\t</title>\r\n");
      out.write("\r\n");
      ...
      out.write("\t<!--\r\n");
      out.write("\r\n");
      out.write("\tfunction Delete(groupName)\r\n");
      out.write("\t{\r\n");
      out.write("\t\tif (confirm(\"");
      out.print(Messages.getBodyJavascriptString(pageContext.getRequest().getLocale(),"listgroups.DeleteAuthorityGroup"));
      out.write(" '\"+groupName+\"'?\"))\r\n");
      out.write("\t\t{\r\n");
      out.write("\t\t\tdocument.listgroups.op.value=\"Delete\";\r\n");
      out.write("\t\t\tdocument.listgroups.groupname.value=groupName;\r\n");
      out.write("\t\t\tdocument.listgroups.submit();\r\n");
      out.write("\t\t}\r\n");
      out.write("\t}\r\n");
      out.write("\r\n");
      out.write("\t//-->\r\n");
      ...
      out.print(Messages.getBodyString(pageContext.getRequest().getLocale(),"listgroups.ListOfAuthorityGroups"));
      out.write("</p>\r\n");
      out.write("\t<form class=\"standardform\" name=\"listgroups\" action=\"execute.jsp\" method=\"POST\">\r\n");
      out.write("\t\t<input type=\"hidden\" name=\"op\" value=\"Continue\"/>\r\n");
      out.write("\t\t<input type=\"hidden\" name=\"type\" value=\"group\"/>\r\n");
	...
	IAuthorityGroup[] groups = manager.getAllGroups();
      ...
      out.print(Messages.getBodyString(pageContext.getRequest().getLocale(),"listgroups.Name"));
      out.write("</td>\r\n");
      out.write("\t\t\t\t<td class=\"columnheader\">");
      out.print(Messages.getBodyString(pageContext.getRequest().getLocale(),"listgroups.Description"));
      out.write("</td>\r\n");
      out.write("\t\t\t</tr>\r\n");
	...
	while (i < groups.length)
	{
      ...
      out.write("\t\t\t\t<nobr>\r\n");
      out.write("\t\t\t\t\t<a href='");
      out.print("viewgroup.jsp?groupname="+org.apache.manifoldcf.core.util.URLEncoder.encode(name));
      out.write("' alt='");
      out.print(Messages.getAttributeString(pageContext.getRequest().getLocale(),"listgroups.View")+" "+org.apache.manifoldcf.ui.util.Encoder.attributeEscape(name));
      out.write('\'');
      out.write('>');
      out.print(Messages.getBodyString(pageContext.getRequest().getLocale(),"listgroups.View"));
      out.write("</a>\r\n");
      out.write("\t\t\t\t\t<a href='");
      out.print("editgroup.jsp?groupname="+org.apache.manifoldcf.core.util.URLEncoder.encode(name));
      out.write("' alt='");
      out.print(Messages.getAttributeString(pageContext.getRequest().getLocale(),"listgroups.Edit")+" "+org.apache.manifoldcf.ui.util.Encoder.attributeEscape(name));
      out.write('\'');
      out.write('>');
      out.print(Messages.getBodyString(pageContext.getRequest().getLocale(),"listgroups.Edit"));
      out.write("</a>\r\n");
      ...
      out.write("' alt='");
      out.print(Messages.getAttributeString(pageContext.getRequest().getLocale(),"listgroups.Delete")+" "+org.apache.manifoldcf.ui.util.Encoder.attributeEscape(name));
      out.write('\'');
      out.write('>');
      out.print(Messages.getBodyString(pageContext.getRequest().getLocale(),"listgroups.Delete"));
      out.write("</a>\r\n");
      out.write("\t\t\t\t</nobr>\r\n");
      out.write("\t\t\t</td>\r\n");
      out.write("\t\t\t<td class=\"columncell\">");
      ...
      out.write("\t\t\t\t<td class=\"separator\" colspan=\"5\"><hr/></td>\r\n");
      out.write("\t\t\t</tr>\r\n");
      out.write("\t\t\t<tr><td class=\"message\" colspan=\"5\"><a href=\"editgroup.jsp\" alt=\"");
      out.print(Messages.getAttributeString(pageContext.getRequest().getLocale(),"listgroups.AddNewGroup"));
      out.write('"');
      out.write('>');
      out.print(Messages.getBodyString(pageContext.getRequest().getLocale(),"listgroups.AddaNewGroup"));
      out.write("</a></td></tr>\r\n");
      out.write("\t\t</table>\r\n");
      out.write("\r\n");
