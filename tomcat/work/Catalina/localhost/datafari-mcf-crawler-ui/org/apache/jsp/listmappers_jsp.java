 ...
 * Generated at: 2015-04-07 13:47:49 UTC
...
public final class listmappers_jsp extends org.apache.jasper.runtime.HttpJspBase
...
*/
      ...
      out.write("\t<title>\r\n");
      out.write("\t\t");
      out.print(Messages.getBodyString(pageContext.getRequest().getLocale(),"listmappers.ApacheManifoldCFListMappers"));
      out.write("\r\n");
      out.write("\t</title>\r\n");
      out.write("\r\n");
      ...
      out.print(Messages.getBodyJavascriptString(pageContext.getRequest().getLocale(),"listmappers.DeleteMapper"));
      ...
      out.print(Messages.getBodyString(pageContext.getRequest().getLocale(),"listmappers.ListOfMappingConnections"));
      out.write("</p>\r\n");
      ...
      out.write("\t\t<input type=\"hidden\" name=\"type\" value=\"mapper\"/>\r\n");
	...
	IMappingConnection[] connections = manager.getAllConnections();
      ...
      out.print(Messages.getBodyString(pageContext.getRequest().getLocale(),"listmappers.Name"));
      out.write("</td>\r\n");
      out.write("\t\t\t\t<td class=\"columnheader\">");
      out.print(Messages.getBodyString(pageContext.getRequest().getLocale(),"listmappers.Description"));
      out.write("</td>\r\n");
      out.write("\t\t\t\t<td class=\"columnheader\">");
      out.print(Messages.getBodyString(pageContext.getRequest().getLocale(),"listmappers.MapperType"));
      out.write("</td>\r\n");
      out.write("\t\t\t\t<td class=\"columnheader\">");
      out.print(Messages.getBodyString(pageContext.getRequest().getLocale(),"listmappers.Max"));
      out.write("</td>\r\n");
      out.write("\t\t\t</tr>\r\n");
	...
	while (i < connections.length)
	{
      ...
      out.write("\t\t\t\t<nobr>\r\n");
      out.write("\t\t\t\t\t<a href='");
      out.print("viewmapper.jsp?connname="+URLEncoder.encode(name));
      out.write("' alt='");
      out.print("View "+org.apache.manifoldcf.ui.util.Encoder.attributeEscape(name));
      out.write('\'');
      out.write('>');
      out.print(Messages.getBodyString(pageContext.getRequest().getLocale(),"listmappers.View"));
      out.write("</a>\r\n");
      out.write("\t\t\t\t\t<a href='");
      out.print("editmapper.jsp?connname="+URLEncoder.encode(name));
      out.write("' alt='");
      out.print(Messages.getAttributeString(pageContext.getRequest().getLocale(),"listmappers.Edit")+" "+org.apache.manifoldcf.ui.util.Encoder.attributeEscape(name));
      out.write('\'');
      out.write('>');
      out.print(Messages.getBodyString(pageContext.getRequest().getLocale(),"listmappers.Edit"));
      out.write("</a>\r\n");
      ...
      out.write("' alt='");
      out.print(Messages.getAttributeString(pageContext.getRequest().getLocale(),"listmappers.Delete")+" "+org.apache.manifoldcf.ui.util.Encoder.attributeEscape(name));
      out.write('\'');
      out.write('>');
      out.print(Messages.getBodyString(pageContext.getRequest().getLocale(),"listmappers.Delete"));
      out.write("</a>\r\n");
      out.write("\t\t\t\t</nobr>\r\n");
      out.write("\t\t\t</td>\r\n");
      out.write("\t\t\t<td class=\"columncell\">");
      ...
      out.write("\t\t\t\t<td class=\"separator\" colspan=\"5\"><hr/></td>\r\n");
      out.write("\t\t\t</tr>\r\n");
      out.write("\t\t\t<tr><td class=\"message\" colspan=\"5\"><a href=\"editmapper.jsp\" alt=\"");
      out.print(Messages.getAttributeString(pageContext.getRequest().getLocale(),"listmappers.AddNewConnection"));
      out.write('"');
      out.write('>');
      out.print(Messages.getBodyString(pageContext.getRequest().getLocale(),"listmappers.AddaNewConnection"));
      out.write("</a></td></tr>\r\n");
      out.write("\t\t</table>\r\n");
      out.write("\r\n");
