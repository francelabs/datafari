 ...
 * Generated at: 2015-04-07 13:47:50 UTC
...
public final class listauthorities_jsp extends org.apache.jasper.runtime.HttpJspBase
...
*/
      ...
      out.write("\t<title>\r\n");
      out.write("\t\t");
      out.print(Messages.getBodyString(pageContext.getRequest().getLocale(),"listauthorities.ApacheManifoldCFListAuthorities"));
      out.write("\r\n");
      out.write("\t</title>\r\n");
      out.write("\r\n");
      ...
      out.print(Messages.getBodyJavascriptString(pageContext.getRequest().getLocale(),"listauthorities.DeleteAuthority"));
      ...
      out.print(Messages.getBodyString(pageContext.getRequest().getLocale(),"listauthorities.ListOfAuthorityConnections"));
      out.write("</p>\r\n");
      ...
      out.write("\t\t<input type=\"hidden\" name=\"type\" value=\"authority\"/>\r\n");
	...
	IAuthorityConnection[] connections = manager.getAllConnections();
      ...
      out.print(Messages.getBodyString(pageContext.getRequest().getLocale(),"listauthorities.Name"));
      out.write("</td><td class=\"columnheader\">");
      out.print(Messages.getBodyString(pageContext.getRequest().getLocale(),"listauthorities.Description"));
      out.write("</td><td class=\"columnheader\">");
      out.print(Messages.getBodyString(pageContext.getRequest().getLocale(),"listauthorities.AuthorityType"));
      out.write("</td>\r\n");
      out.write("\t\t\t\t<td class=\"columnheader\">");
      out.print(Messages.getBodyString(pageContext.getRequest().getLocale(),"listauthorities.Max"));
      out.write("</td>\r\n");
      out.write("\t\t\t</tr>\r\n");
	...
	while (i < connections.length)
	{
      ...
      out.write("\t\t\t\t<nobr>\r\n");
      out.write("\t\t\t\t\t<a href='");
      out.print("viewauthority.jsp?connname="+org.apache.manifoldcf.core.util.URLEncoder.encode(name));
      out.write("' alt='");
      out.print("View "+org.apache.manifoldcf.ui.util.Encoder.attributeEscape(name));
      out.write('\'');
      out.write('>');
      out.print(Messages.getBodyString(pageContext.getRequest().getLocale(),"listauthorities.View"));
      out.write("</a>\r\n");
      out.write("\t\t\t\t\t<a href='");
      out.print("editauthority.jsp?connname="+org.apache.manifoldcf.core.util.URLEncoder.encode(name));
      out.write("' alt='");
      out.print(Messages.getAttributeString(pageContext.getRequest().getLocale(),"listauthorities.Edit")+" "+org.apache.manifoldcf.ui.util.Encoder.attributeEscape(name));
      out.write('\'');
      out.write('>');
      out.print(Messages.getBodyString(pageContext.getRequest().getLocale(),"listauthorities.Edit"));
      out.write("</a>\r\n");
      ...
      out.write("' alt='");
      out.print(Messages.getAttributeString(pageContext.getRequest().getLocale(),"listauthorities.Delete")+" "+org.apache.manifoldcf.ui.util.Encoder.attributeEscape(name));
      out.write('\'');
      out.write('>');
      out.print(Messages.getBodyString(pageContext.getRequest().getLocale(),"listauthorities.Delete"));
      out.write("</a>\r\n");
      out.write("\t\t\t\t</nobr>\r\n");
      out.write("\t\t\t</td>\r\n");
      out.write("\t\t\t<td class=\"columncell\">");
      ...
      out.write("\t\t\t\t<td class=\"separator\" colspan=\"5\"><hr/></td>\r\n");
      out.write("\t\t\t</tr>\r\n");
      out.write("\t\t\t<tr><td class=\"message\" colspan=\"5\"><a href=\"editauthority.jsp\" alt=\"");
      out.print(Messages.getAttributeString(pageContext.getRequest().getLocale(),"listauthorities.AddNewConnection"));
      out.write('"');
      out.write('>');
      out.print(Messages.getBodyString(pageContext.getRequest().getLocale(),"listauthorities.AddaNewConnection"));
      out.write("</a></td></tr>\r\n");
      out.write("\t\t</table>\r\n");
      out.write("\r\n");
