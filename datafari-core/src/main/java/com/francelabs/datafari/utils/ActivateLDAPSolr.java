...
public class ActivateLDAPSolr {
	...
	private ActivateLDAPSolr() {
		final String filePath = Environment.getProperty("catalina.home") + File.separator + ".." + File.separator
				+ "solr" + File.separator + "solrcloud" + File.separator + "FileShare" + File.separator + "conf"
				+ File.separator + "solrconfig.xml";
		solrConfig = new File(filePath);
		final String filePathJSON = Environment.getProperty("catalina.home") + File.separator + ".." + File.separator
				+ "bin" + File.separator + "common" + File.separator + "config" + File.separator + "manifoldcf"
				+ File.separator + "monoinstance" + File.separator + "authorityconnections" + File.separator
				+ "authorityConnection.json";
		final String filePathGroupJSON = Environment.getProperty("catalina.home") + File.separator + ".."
				+ File.separator + "bin" + File.separator + "common" + File.separator + "config" + File.separator
				+ "manifoldcf" + File.separator + "monoinstance" + File.separator + "authorityconnections"
				+ File.separator + "authorityGroups.json";
		new File(filePathJSON);
		new File(filePathGroupJSON);

		// Custom searchHandler
		final String customSearchHandlerPath = Environment.getProperty("catalina.home") + File.separator + ".."
				+ File.separator + "solr" + File.separator + "solrcloud" + File.separator + "FileShare" + File.separator
				+ "conf" + File.separator + "customs_solrconfig" + File.separator + "custom_search_handler.incl";
