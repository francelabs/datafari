...
public class StatsUtils {
  ...
  public static final List<String> statFields = new ArrayList<>(
      Arrays.asList("id", "date", "q", "noHits", "numFound", "numClicks", "QTime", "positionClickTot", "click", "history", "url"));
  ...
  public static String createStatLog(final HashMap<String, Object> doc, final String username) {
    ...
    for (final String statField : statFields) {
      ...
      final Object value = doc.get(statField);
      if (value != null) {
        if (value instanceof Date) {
          // Create an instance of SimpleDateFormat used for
          // formatting
