...
public class GetHighlightInfos extends HttpServlet {
  ...
  private static final Logger logger = Logger.getLogger(GetHighlightInfos.class.getName());

  /**
   * @see HttpServlet#HttpServlet()
   */
  public GetHighlightInfos() {
    super();
  ...
  protected void doGet(final HttpServletRequest request, final HttpServletResponse response) throws ServletException, IOException {
    ...
    final String maxAnalyzedChars = HighlightConfiguration.getInstance().getProperty(HighlightConfiguration.MAX_ANALYZED_CHARS);
