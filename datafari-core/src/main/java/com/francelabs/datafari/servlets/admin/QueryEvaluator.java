...
public class QueryEvaluator extends HttpServlet {
	...
	protected void doGet(final HttpServletRequest request, final HttpServletResponse response)
		...
		try {
			...
			Map<String, Integer> rankedDocuments = DocumentDataService.getInstance().getRank(query, docIDs); 
			 jsonResponse.put("docs", rankedDocuments).put(OutputConstants.CODE, CodesReturned.ALLOK.getValue());
			// }
