...
public class ScriptConfiguration {
	...
	public static void setProperty(String key, String value) throws IOException {
		...
		getInstance().properties.store(new FileOutputStream(ScriptConfiguration.class.getClassLoader().getResource(configPropertiesFileName).getFile()), null);
	}
	...
	private ScriptConfiguration() throws IOException {
		...
		properties.load(ScriptConfiguration.class.getClassLoader().getResourceAsStream(configPropertiesFileName));
	}
