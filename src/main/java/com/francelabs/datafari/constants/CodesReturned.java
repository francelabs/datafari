package com.francelabs.datafari.constants;

public class CodesReturned {
	public static final int TRUE = 3;
	public static final int FALSE = 2;
	public static final int ALREADYPERFORMED = 1;
	...
	public static final int PROBLEMCONNECTIONAD = -6;
	public static final int ADUSERNOTEXISTS = -900;
