...
#define PACKAGE_STRING "PostgreSQL 9.3.3"

/* Define to the version of this package. */
#define PACKAGE_VERSION "9.3.3"

/* Define to the name of a signed 64-bit integer type. */
#define PG_INT64_TYPE long long int

/* PostgreSQL version as a string */
#define PG_VERSION "9.3.3"

/* PostgreSQL version as a number */
#define PG_VERSION_NUM 90303
...
#define PG_VERSION_STR "PostgreSQL 9.3.3, compiled by Visual C++ build " __STRINGIFY2(_MSC_VER) ", 32-bit"
...
#define HAVE_LIBXSLT
#define USE_LIBXSLT
#define VAL_CONFIGURE "--enable-thread-safety --enable-integer-datetimes --enable-nls --with-ldap --with-ossp-uuid --with-libxml --with-libxslt --with-tcl --with-perl --with-python"
