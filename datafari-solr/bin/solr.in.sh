...
#SOLR_OPTS="$SOLR_OPTS -Dsolr.log.requestlog.retaindays=90 -Djavax.net.ssl.trustStore=/opt/datafari/ssl-keystore/datafari-truststore.p12 -Djavax.net.ssl.trustStorePassword=DataFariAdmin"
