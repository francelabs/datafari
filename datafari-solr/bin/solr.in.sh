...
SOLR_OPTS="$SOLR_OPTS -Dsolr.disableConfigSetsCreateAuthChecks=true -Djute.maxbuffer=10000000 -Dsolr.allowPaths=* -Dorg.eclipse.jetty.server.Request.maxFormKeys=10000"
