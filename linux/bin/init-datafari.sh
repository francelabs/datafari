...
generate_certificates_apache() {
  ...
  $JAVA_HOME/bin/keytool -importcert -noprompt -alias openaiapi -file $DATAFARI_HOME/ssl-keystore/rootCertificates/openai-api.pem -trustcacerts -keystore $DATAFARI_HOME/ssl-keystore/datafari-truststore.p12 -storepass DataFariAdmin
