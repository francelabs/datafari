...
sleep 5
 ...
 curl -XGET "http://$SOLR:8983/solr/admin/collections?action=CREATE&name=FileShare&collection.configName=FileShare&numShards=2&maxShardsPerNode=2&replicationFactor=1&&property.mcf.ip=http://datafari:9080/datafari-mcf-authority-service&property.lib.path=/var/solr/solrcloud/FileShare/"
