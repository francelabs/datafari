...
#define CONFIGURE_ARGS " '--without-readline' '--without-zlib' '--without-icu'"
...
#define PG_VERSION_STR "PostgreSQL 18.3 on x86_64-pc-linux-gnu, compiled by gcc (GCC) 11.5.0 20240719 (Red Hat 11.5.0-11), 64-bit"
