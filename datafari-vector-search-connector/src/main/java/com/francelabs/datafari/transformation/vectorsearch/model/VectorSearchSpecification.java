package com.francelabs.datafari.transformation.vectorsearch.model;

import com.francelabs.datafari.transformation.vectorsearch.VectorSearchConfig;
...
/**
 * This class contains specifications for the VectorSearch Connector.
 */
public class VectorSearchSpecification {

    private static final Logger LOGGER = LogManager.getLogger(VectorSearchSpecification.class.getName());


    Map<String,Object> spec = new HashMap<>();

    public VectorSearchSpecification() {
        // Empty connector
        spec.put(VectorSearchConfig.NODE_ENABLE_VECTOR_SEARCH, true);
        spec.put(VectorSearchConfig.NODE_ENABLE_EMBEDDINGS_AT_INDEXING, true);
    }

    public VectorSearchSpecification(Specification os, ConfigParams config) {
        spec.put(VectorSearchConfig.NODE_ENABLE_VECTOR_SEARCH, true);
        spec.put(VectorSearchConfig.NODE_ENABLE_EMBEDDINGS_AT_INDEXING, true);
        ...
        for (int i = 0; i < os.getChildCount(); i++) {
            ...
            setProperty(attributeName, sn.getAttributeValue(VectorSearchConfig.ATTRIBUTE_VALUE));
        }
    }
    ...
    public boolean equals(Object obj) {
        ...
        VectorSearchSpecification other = (VectorSearchSpecification) obj;
